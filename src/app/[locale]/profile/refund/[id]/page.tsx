...
export default function RefundDetailPage({
  ...
  const FAKE_DETAIL_REFUND: TRefundDetail = {
            ...
            <div className="row g-4">
              ...
              <div className="col-xl-9 col-sm-8">
                ...
                >
                  ...
                  {t('profile.detailRefund')}
                </span>
                <div className="row">
                  <div className="col-lg-6">
                    <DetailRefundStatus refund={FAKE_DETAIL_REFUND} />
                    <RefundReason refund={FAKE_DETAIL_REFUND} />
                    <RefundProduct refund={FAKE_DETAIL_REFUND} />
                    <TotalRefund refund={FAKE_DETAIL_REFUND} />
                  </div>
                  <div className="col-lg-6">
                    <RefundDetailStatus refund={FAKE_DETAIL_REFUND} />
                  </div>
                </div>
              </div>
            </div>
