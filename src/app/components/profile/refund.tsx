...
import { TRefundList } from '@/types/order.type';
...
async function Refund() {
  ...
  const orderList = () => {
    ...
    let selectedList: TRefundList[] = [];

    switch (activeFilter) {
      case 'all':
        selectedList = FAKE_REFUND;
        break;
      case 'waiting_confirmation':
        selectedList = FAKE_REFUND.filter(
          (o) => o.status === 'Waiting Confirmation',
        );
        break;
      case 'approve':
        selectedList = FAKE_REFUND.filter((o) => o.status === 'Approve');
        break;
      case 'on_process':
        selectedList = FAKE_REFUND.filter((o) => o.status === 'On Process');
        break;
      case 'completed':
        selectedList = FAKE_REFUND.filter((o) => o.status === 'Completed');
        break;
      case 'reject':
        selectedList = FAKE_REFUND.filter((o) => o.status === 'Rejected');
        break;
      case 'cancel':
        selectedList = FAKE_REFUND.filter((o) => o.status === 'Canceled');
        break;
